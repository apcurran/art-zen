    ...
    return (
        <main className="main-about">
            ...
            <section className="main-about__section">
                ...
                <figure className="main-about__section__fig">
                    <img src={SharingArticlesIllustration} alt="Man and a woman text artwork to each other." width="989" height="766" loading="lazy" className="main-about__section__fig__img"/>
                </figure>
            </section>
            ...
            <section className="main-about__section">
                <figure className="main-about__section__fig">
                    <img src={MonsterArtistIllustration} alt="Monster with a mustache displays artwork with orange circles." width="738" height="401" loading="lazy" className="main-about__section__fig__img"/>
                </figure>
                <div className="main-about__section__content">
                    <h2 className="main-about__section__title">
