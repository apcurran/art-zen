        ...
        <main className="main-about">
            <section className="main-about__section">
                <figure className="main-about__section__fig">
                    <img
                        src={ArtMuseumIllustration}
                        alt="Illustration of a man staring at art in a museum."
                        width="1046"
                        height="639"
                        decoding="async"
                        className="main-about__section__fig__img"
                    />
                </figure>
                <div className="main-about__section__content">
                    ...
                    <p className="main-about__section__desc">
                        Art Zen has fresh artwork added daily by artists just
                        like you. We provide a source of inspiration, any time
                        of day.
                    </p>
                </div>
            </section>
            ...
            <section className="main-about__section">
                <div className="main-about__section__content">
                    ...
                    <p className="main-about__section__desc">
                        Share your struggles and challenges, post tips on other
                        artists' pages, or show some love by favoriting a piece
                        you like.
                    </p>
                </div>
                <figure className="main-about__section__fig">
                    <img
                        src={SharingArticlesIllustration}
                        alt="Man and a woman text artwork to each other."
                        width="989"
                        height="766"
                        loading="lazy"
                        decoding="async"
            ...
            <section className="main-about__section">
                <figure className="main-about__section__fig">
                    <img
                        src={MonsterArtistIllustration}
                        alt="Monster with a mustache displays artwork with orange circles."
                        width="738"
                        height="401"
                        loading="lazy"
                        decoding="async"
                ...
                <div className="main-about__section__content">
                    ...
                    <p className="main-about__section__desc">
                        Join a fun community of helpful people who want to grow
                        their art skills everyday!
                    </p>
                </div>
            </section>
        </main>
