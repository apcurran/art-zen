...
function ArtworkInfo({
    ...
    return (
        <section className="artwork-view__info">
            ...
            <Link
                to={{ pathname: `/artworks/users/${artworkData.userId}` }}
                className="artwork-view__info__author"
            >
                {artworkData.username}
            </Link>
            <div>
            ...
            <div className="artwork-view__info__social-data">
                <div
                    onClick={updateLikes}
                    className="artwork-view__info__social-data__container"
                >
                    <svg
                        className={
                            currUserHasLiked
                                ? "like-heart-icon--full like-heart-icon"
                                : "like-heart-icon"
                        }
                        fill="none"
                        stroke="currentColor"
                    ...
                    <span className="artwork-view__info__social-data__totals">
                        {likes.length} Likes
                    </span>
                </div>
                <div
                ...
                >
                    <svg
                        className={
                            currUserHasFavorited
                                ? "favorite-star-icon--full favorite-star-icon"
                                : "favorite-star-icon"
                        }
                        fill="none"
                        stroke="currentColor"
            ...
            <p className="artwork-view__info__desc">
                {artworkData.description}
            </p>
            {artworkData.artworkCreatedAt ? (
                <p className="artwork-view__info__date">
                    Published on{" "}
                    <time>{formatDate(artworkData.artworkCreatedAt)}</time>
                </p>
            ) : null}
        </section>
    );
