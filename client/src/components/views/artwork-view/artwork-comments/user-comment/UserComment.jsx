    ...
    return (
        <article className="comment-segment">
            ...
            <div className="comment-segment__info">
                <h4 className="comment-segment__info__username">
                    {comment.comment_username}
                </h4>
                <time className="comment-segment__info__date">
                ...
                {comment.user_id === userId ? (
                    <button
                        ...
                        className="comment-segment__info__delete-btn"
                    >
                        <svg
                        ...
                        <span className="comment-segment__info__delete-btn__span">
                            Delete
                        </span>
                    </button>
                ) : null}
