    ...
    return (
        <div className="artwork-view__comments-section">
            <section className="artwork-view__comments-total">
                <span className="artwork-view__comments-total__title">
                    Comments
                </span>
                <span className="dot">&bull;</span>
                <span className="artwork-view__comments-total__amt">
                    {comments.length}
                </span>
            </section>
                ...
                {isLoggedIn ? (
                    ...
                    <div className="artwork-view__comments__user__logged-out">
                        ...
                        <p className="artwork-view__comments__user__logged-out__desc">
                            Join the Art Zen community to post your comment. If
                            you are already a member,{" "}
                            <Link
                                to="/auth/log-in"
                                className="artwork-view__comments__user__logged-out__desc__link"
                            >
                                Log In
                            </Link>
                            .
